...
//
//public class UserActivity_OLD extends AppCompatActivity {
//
//
...
//
//        Button btnCreateButtons;
//        btnCreateButtons = findViewById(R.id.btn_create_buttons);
//
//        btnCreateButtons.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                initRadioButtonsLayouts();
//            }
//        });
//
//        Button btnShowListGenders;
//        btnShowListGenders = findViewById(R.id.btn_show_list_genders);
//
//        btnShowListGenders.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                showGlobalListGenders();
//            }
//        });
//
//
//    }
//
//    public void showGlobalListGenders(){
...
//        Toast.makeText(UserActivity.this,"CONNECTED USER : " + userId + "/" + userNickName, Toast.LENGTH_SHORT).show();
//
//
//
//        Log.i(TAG, "------- myArrayListGenders.size() ---------" + myArrayListGenders.size());
//        Log.i(TAG, "------- myArrayListGenders ---------" + myArrayListGenders);
//        Log.i(TAG, "-----------------------------");
//
//    }
//
...
////    }
//
//    private void DisplayArrayGendersCount(View v) {//onClickButton
//        Log.i(TAG, "------- DisplayArrayGendersCount() ---------");
//
//        GlobalClass globalVariables = (GlobalClass) getApplicationContext();
//        globalVariables.LoadGendersDataFromFirestore();
//
//        ArrayList<ModelGenders> arrayListGenders = new ArrayList<>();
//        arrayListGenders    =   globalVariables.getArrayListGenders();
//
//
//        Log.i(TAG, "------- arrayListGenders ---------" + arrayListGenders.size());;
//        Log.i(TAG, "------- arrayListGenders ---------" + arrayListGenders.size());;
//
//    }
//
...
//        Log.i(TAG, "------- END OF initGlobalVariables ---------");
//    }
//    public void initRadioButtonsLayouts() { //onClickButton
...
//
//        String message = "";
////      message = (arrayListGenders.size() == null) ? "Array vide" : arrayListGenders.size();
//        Log.i(TAG, "------- arrayListGenders --------- " + message + " //////");
//        Log.i(TAG, "------- arrayListGenders --------- " + arrayListGenders.size() + " //////");
//        Log.i(TAG, "------- arrayListGenders --------- " + arrayListGenders + " //////");
//
//    }
//
//
//    public void initHobbiesLayout(){ //onClickButton
...
//
//
//    public void initGendersLayout(){//onClickButton
